    ...
    void OnEnable()
    {
        ...
        activatorList.drawElementCallback = (Rect rect, int index, bool isActive, bool isFocused) =>
        {
            ...
            else if (activeActivator.intValue == 3)
            {
                ...
                actorToRec.intValue = EditorGUI.Popup(new Rect(rect.x, rect.y, rect.width - 5, EditorGUIUtility.singleLineHeight), actorToRec.intValue, Actors.Actor.ActorSubtypeNames);
            }
