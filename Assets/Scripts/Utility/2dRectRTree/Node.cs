...
namespace RTree
{
    ...
    public class Node<T>
    {
        ...
        public Node(int nodeId, int level, int maxNodeEntries)
        {
            this.nodeId = nodeId;
            this.level = level;
            entries = new Rect[maxNodeEntries];
            ids = new int[maxNodeEntries];
        }

        internal void addEntry(Rect r, int id)
        {
            ids[entryCount] = id;
        ...
        internal void addEntryNoCopy(Rect r, T item)
        {
            ids[entryCount] = item;
        ...
        internal int findEntry(Rect r, int id)
        {
        ...
        internal void deleteEntry(int i, int minNodeEntries)
        {
            ...
            Rect deletedRectangle = entries[i];
            entries[i] = null;
            if (i != lastIndex)
            {
        ...
        internal void recalculateMBR(Rect deletedRectangle)
        {
        ...
        public Rect getEntry(int index)
        {
            if (index < entryCount)
            {
