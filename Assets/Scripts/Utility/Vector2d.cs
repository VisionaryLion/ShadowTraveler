...
namespace UnityEngine
{
    ...
    public struct Vector2d
    {
        ...
        public static bool AproximatleyEqual(Vector2d f1, Vector2d f2, double fudge)
        {
            return Math.Abs(f1.x - f2.x) < fudge && Math.Abs(f1.y - f2.y) < fudge;
        }
        ...
        {
            return String.Format(format, (object)this.x, (object)this.y);
        }
